...
```{r}
get_btype_graphs(vius1 = vius_data,
                 var = "GVWR",
...
The `get_state_maps()` function visualizes state-level VIUS data on an interactive U.S. map.

```{r}
get_state_maps(vius = vius_data,
               var = "FUELVOL",
...
get_state_graphs(dataset = vius_data,
                  db_header = "GVWR",
                  states = c("CA", "TX", "NY"),
                  plot_title = "Average GVWR by State",
                  x_plot_label = "Average GVWR",
                  y_plot_label = "State")
